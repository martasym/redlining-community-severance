...
saveRDS(UK_mean_uniform_ok_new, paste0(main_folder, generated.folder.CSI, "traffic_segment_2_grid_sld_new_070126", name_short ,".rds"))

# Version used in CSI
Used_traffic_segment <- readRDS(paste0(main_folder, "CSI/Data Test/", "traffic_segment_2_grid_sld_new_070126", name_short ,".rds"))
